...
# }
  ...
  d_samp = {
    ...
    'data15-16'     :{'type':'data','leg':'Data (2015,2016)',     'f_color':kBlack,'l_color':kBlack,  'path': 'data'+data_suffix,'m_type':24, "lumi":3219.56+32988.1, "sqrts":13},
    'data15'     :{'type':'data','leg':'Data (2015)',     'f_color':kBlack,'l_color':kBlack,  'path': 'data'+data_suffix,'m_type':24, "lumi":3219.56, "sqrts":13},
    'data16'     :{'type':'data','leg':'Data (2016)',     'f_color':kBlack,'l_color':kBlack,  'path': 'data'+data_suffix,'m_type':24, "lumi":32988.1, "sqrts":13},
    'alldata'     :{'type':'data','leg':'Data (2015-2018)',     'f_color':kBlack,'l_color':kBlack,  'path': 'data'+data_suffix,'m_type':20, "lumi":44307.4+58450.1+32988.1+3219.56, "sqrts":13},
    'data17'     :{'type':'data','leg':'Data (2017)',             'f_color':kBlack,'l_color':kBlack,  'path': 'data'+data_suffix,'m_type':25,"lumi":44307.4, "sqrts":13},
    'data18'     :{'type':'data','leg':'Data (2018)',             'f_color':kBlack,'l_color':kBlack,  'path': 'data'+data_suffix,'m_type':26,"lumi":58450.1, "sqrts":13},
    'data22'     :{'type':'data','leg':'Data (2022)',             'f_color':kBlack,'l_color':kBlack,  'path': 'data'+data_suffix,'m_type':26,"lumi":1258.27,"sqrts":13.6},
    ...
    'ZjetsPhPy'    :{'type':'bkg', 'leg':'Z+jets (PhPy)',                    'f_color':myDarkGreen,  'path':'Zjets'+bkg_suffix},
    'Zeejets'    :{'type':'bkg', 'leg':'Z(ee)+jets',                    'f_color':kAzure-9,  'path':'Zeejets'+bkg_suffix},
    'WmuHNL50_60G_lt01dd': {'type':'sig', 'leg':'W\' #rightarrow N ',         'f_color':kRed, 'path':'WmuHNL50_60G_lt01dd_lepfilt_ch'+bkg_suffix},
    ...
    'diboson2L'  :{'type':'bkg', 'leg':'Diboson2L',                   'f_color':myMediumOrange, 'path':'diboson'+bkg_suffix},
    'diboson3L'  :{'type':'bkg', 'leg':'Diboson3L',                   'f_color':myLightOrange, 'path':'diboson'+bkg_suffix},
    'diboson4L'  :{'type':'bkg', 'leg':'Diboson4L',                   'f_color':myLighterOrange, 'path':'diboson'+bkg_suffix},
