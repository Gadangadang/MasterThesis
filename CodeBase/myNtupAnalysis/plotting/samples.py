...
# }
  ...
  d_samp = {
    ...
    'singletop':{'type':'bkg', 'leg':'Single top',                'f_color':kYellow-4,  'path':'singleTop'+bkg_suffix},
    'Zjets2'    :{'type':'bkg', 'leg':'Z+jets2',                    'f_color':kOrange+1,  'path':'Zjets2'+bkg_suffix},
    ...
    'diboson2L'  :{'type':'bkg', 'leg':'Diboson2L',                   'f_color':kOrange+2, 'path':'diboson2L'+bkg_suffix},
      'diboson3L'  :{'type':'bkg', 'leg':'Diboson3L',                   'f_color':kOrange+4, 'path':'diboson3L'+bkg_suffix},
      'diboson4L'  :{'type':'bkg', 'leg':'Diboson4L',                   'f_color':kOrange+6, 'path':'diboson4L'+bkg_suffix},
