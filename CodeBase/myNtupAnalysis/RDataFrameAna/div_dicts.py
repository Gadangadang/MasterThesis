triggers = {
    "2015": {
        ...
        "trigmatch": "ROOT::VecOps::Sum(lepHLT_2e12_lhloose_L12EM10VH[isGoodLep] && lepPt[isGoodLep] > 12 ) >= 2 \
    ...
    "2016": {
        "trig": "trigMatch_HLT_2e17_lhvloose_nod0 || trigMatch_HLT_e17_lhloose_nod0_mu14 || trigMatch_HLT_mu22_mu8noL1 || is2015 || is2017 || is2018",
        "trigmatch": "ROOT::VecOps::Sum(lepHLT_2e17_lhvloose_nod0[isGoodLep] && lepPt[isGoodLep] > 17 ) >= 2 \
