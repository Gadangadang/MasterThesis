...
\begin{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \begin{figure}[h!]
            \centering
            \caption[Zeejets channel diagram]{Proton-proton collision showing the Zeejets channel. Here one of the Z bosons decay leptonically and the W boson
            decays hadronically. }
...
\subsection*{2 lepton + $e_T^{miss}$ background MonteCarlo}
