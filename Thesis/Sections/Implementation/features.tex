...
the variaty of final states of the reconstructed events, i.e. that one event has two ljets, zero bjets, one electron and two muons, whereas another 
...
of at least 14 GeV to be triggered for a given event. The other componentents in some other triggers are more complicated, and 
