...
\begin{tikzpicture}
    ...
    \caption{The production of a heavy neutrino through the SM $W^{\pm}$ boson, with the three lepton final state.}
\end{figure}
...
\begin{tikzpicture}
    ...
    \caption{The production of a heavy neutrino through the right handed $W_R^{\pm}$ boson, with the three lepton final state.}
\end{figure}
