...
%%%%%%%%%%%%%%  SM and BSM  %%%%%%%%%%%%%%%%%%%%%%%
\chapter{The Standard Model and Beyond Standard Model physics}\label{Chap:SM}
...
\input{Sections/Results/32lep_discuss}
\input{Sections/Results/exec_summary}
\input{Sections/Results/challenges_future}
